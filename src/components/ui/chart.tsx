...
> {
  active?: boolean
  payload?: Array<ChartTooltipPayload>
  className?: string
...
interface ChartLegendContentProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  verticalAlign?: 'top' | 'bottom' | 'left' | 'right' // sesuai LegendProps
  hideIcon?: boolean
  nameKey?: string
}
  ...
  return (
    ...
    >
      {payload.map((item, index) => {
        ...
        return (
          <div
            key={index} // gunakan index kalau value bisa undefined
            className={cn(
